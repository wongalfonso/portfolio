  ...
  return (
    <div className='container'>
          ...
          <div className='row project-rows'>
            ...
            <div className='col-sm-12 col-xl-6 '>
              <div className="info-div">
                <p className='infoTitle'> <u>Change Calculator</u> {gitHubLink('https://github.com/wongalfonso/React-Change-Calculator', 'change')}</p>
          ...
          <div className='row project-rows' >
            ...
            <div className="col-sm-12 col-xl-6">
              <div className='info-div'>
                <p className='infoTitle'> <u>Astro Calculator</u> {this.gitHubLink('https://github.com/wongalfonso/Astro-Weight-React', 'astro')} </p>
